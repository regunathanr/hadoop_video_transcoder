...
Java_WordCountMapper_mpeg2decMain(JNIEnv *env, jobject obj, jbyteArray buffer_java,jint bufsize,jintArray sequence_info_arr,jbyteArray jpg_outputbuffer_java, jintArray jpg_indexvec, jint output_bufsize,jintArray act_numframes_written)
{
    int i;
    int argc;
    char** argv;
